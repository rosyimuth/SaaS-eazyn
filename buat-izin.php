                    ...
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                          ...
                          <select class="form-select" aria-label="guru_id">
                            <option selected></option>
                            <option value="1">Catarina Setyawati Marsiana</option>
                            <option value="2">Diyono</option>
                            <option value="3">Eka Nur Ahmad Romadhoni</option>
                            <option value="4">Nikmah Rokhani</option>
                            <option value="5">Rr. Retna Trimantaraningsih</option>
                          </select>
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Alasan</label>
                          <input type="password" class="form-control" id="alasan">
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Mulai Jam</label>
                          <select class="form-select" aria-label="mulai_jam">
                            <option selected></option>
                        ...
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Sampai Jam</label>
                          <select class="form-select" aria-label="sampai_jam">
                            <option selected></option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                        ...
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="file_pendukung">File Pendukung</label>
